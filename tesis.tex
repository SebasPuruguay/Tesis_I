...
\fancypagestyle{special}{%
	\fancyhead[L]{\changefont Aplicación de técnicas de Vision Computacional para la clasificacion temprana de "Rancha" Phytophthora infestans en las hojas de papa peruan}
	\fancyhead[R]{\thepage}}
...
\begin{titlepage}
	...
	\begin{center}
		...
		\vspace*{8ex} \\
		%\textbf
		{Aplicación de técnicas de Vision Computacional para la clasificacion temprana de "Rancha" Phytophthora infestans en las hojas de papa peruan}
		\vspace*{8ex}\\	
		Tesis para optar el Título de Ingeniero de Tecnologías de Información y Sistemas que presenta: 
		\vspace*{8ex} \\	
		Sebastian Jesus Puruguay Leon \\
